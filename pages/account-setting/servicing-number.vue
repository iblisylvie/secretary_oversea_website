  ...
  <section class="get-start">
    ...
    <main class="get-start-main">
      ...
      <template v-if="activeStep === 0">
        ...
        <p
          data-v-5a172b86=""
          style="font-size: 11px;margin-bottom: 6px;margin-top: 6px;text-align: left;
"
        >
          *Unfortunately Google Fi & Google Voice is not supoorted. We will work
          as hard as we can to support this carrier.
        </p>
      </template>
      <!-- Bind Number  -->
...
export default {
  name: 'AccountSettingServicingNumber',
  layout: 'dashboard',
