<template>
  <section class="container content">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Mobvoi.
    </p>
    <p>
      Mobvoi is committed to ensuring that the app is as useful and efficient as
    ...
    <p>
      The HeyTico app stores and processes personal data that you have provided
      ...
      features and it could mean that the HeyTico app won’t work properly or at
      all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Mobvoi will not
      ...
      provided by your mobile network provider, but Mobvoi cannot take
    ...
    <p>
      Along the same lines, Mobvoi cannot always take responsibility for the way
      ...
      Mobvoi cannot accept responsibility.
    </p>
    <p>
      With respect to Mobvoi’s responsibility for your use of the app, when
      ...
      available to you. Mobvoi accepts no liability for any loss, direct or
      indirect, you experience as a result of relying wholly on this
      functionality of the app.
    </p>
    <p>
      At some point, we may wish to update the app. The app is currently
      available on Android, iOS &amp; KaiOS – the requirements for system(and
      ...
      keep using the app. Mobvoi does not promise that it will always update the
      app so that it is relevant to you and/or works with the Android, iOS &amp;
      KaiOS version that you have installed on your device. However, you promise
    ...
    <p>
      ...
      do not hesitate to contact us at help@HeyTico.com.
    </p>
  </section>
</template>
